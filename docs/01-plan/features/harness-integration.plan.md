...
> **Created**: 2026-03-30
> **Status**: Draft
> **관련 문서**: `domain-discovery-pipeline.plan.md` v0.3의 Phase B/C를 확장
  ...
  "steps": [
    {
      ...
      "parallel_group": null,
      "depends_on": [],
      "outputs": ["docs/03-do/{domain-slug}/steps/step-1-glossary.md"]
    },
    {
      "id": "step-4",
      "name": "이미지 생성",
      ...
      "parallel_group": null,
      "depends_on": ["step-3"],
      "outputs": ["docs/03-do/{domain-slug}/output/thumbnails/"]
    }
  ],
  "execution": {
    ...
    "workspace": "docs/03-do/{domain-slug}/"
  }
}
```
...
```
docs/03-do/{domain-slug}/           ← workspace
...
기존 `docs/03-do/youtube-thumbnail/` 파이프라인을 새 실행 방식으로 재실행:
